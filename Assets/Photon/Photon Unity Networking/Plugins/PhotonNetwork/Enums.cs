...
{
    /// <summary>向其他人发送RPC并且本地立即执行，玩家加入后不会立即执行</summary>
    ...
    All,
    /// <summary>向其他人发送RPC。并且本地不执行，玩家加入后不会立即执行</summary>
    ...
    MasterClient,
    /// <summary>向其他人发送RPC并且本地立即执行，新玩家加入后会执行缓冲的RPC</summary>
    ...
    AllBuffered,
    /// <summary>向其他人发送RPC,本地不执行，新玩家加入后会执行缓冲的RPC</summary>
    ...
    OthersBuffered,
    /// <summary>RPC发送给每个人都通过服务器（包括此客户端）/summary>
    ...
    /// </remarks>
    AllViaServer,
    /// <summary>RPC发送给每个人都通过服务器（包括此客户端），并且加入缓冲/summary>
